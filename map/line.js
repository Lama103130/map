 ...
 var haldenStasjonMarker = L.marker([59.120205, 11.383907]).addTo(map)
 var fredrikstadMarker = L.marker([59.209000, 10.950248]).addTo(map)
...
var fredrikstadToHaldenGeoJson = {
  ...
  // Define layers for Sarpsborg routes
var sarpsborgToHaldenRoute = L.geoJSON(sarpsborgToHaldenGeoJson, {
    style: { color: 'blue', weight: 2 },
    onEachFeature: function (feature, layer) {
      layer.bindPopup('Route from Sarpsborg to Halden');
    }
  });
  
  //Define layers for Fredrikstad routes
  var fredrikstadToHaldenRoute = L.geoJSON(fredrikstadToHaldenGeoJson, {
    style: { color: 'green', weight: 2 },
    onEachFeature: function (feature, layer) {
      layer.bindPopup('Route from Fredrikstad to Halden');
    }
  });

  // Grouping markers and routes for Sarpsborg and Fredrikstad
var sarpsborgGroup = L.layerGroup([sarpsborgMarker, sarpsborgToHaldenRoute]);
...
// Overlay layers for routes
var overlayMaps = {
  "Sarpsborg to Halden": sarpsborgGroup,
  "Fredrikstad to Halden": fredrikstadGroup
};
